...
void Packet::copy(const Packet& other)
{
    ...
    this->packetHello = other.packetHello;
    this->packetEcho = other.packetEcho;
}
...
void Packet::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->totalCount);
    doParsimPacking(b,this->packetHello);
    doParsimPacking(b,this->packetEcho);
}
...
void Packet::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->totalCount);
    doParsimUnpacking(b,this->packetHello);
    doParsimUnpacking(b,this->packetEcho);
}
...
int Packet::getTotalCount() const
{
    return this->totalCount;
}

void Packet::setTotalCount(int totalCount)
{
    this->totalCount = totalCount;
}

bool Packet::getPacketHello() const
{
    return this->packetHello;
}

void Packet::setPacketHello(bool packetHello)
{
    this->packetHello = packetHello;
}

bool Packet::getPacketEcho() const
{
    return this->packetEcho;
}

void Packet::setPacketEcho(bool packetEcho)
{
    this->packetEcho = packetEcho;
}
...
unsigned int PacketDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_totalCount
        FD_ISEDITABLE,    // FIELD_packetHello
        FD_ISEDITABLE,    // FIELD_packetEcho
    };
...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "totalCount") == 0) return baseIndex + 3;
    if (strcmp(fieldName, "packetHello") == 0) return baseIndex + 4;
    if (strcmp(fieldName, "packetEcho") == 0) return baseIndex + 5;
...
const char *PacketDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "int",    // FIELD_hopCount
        "int",    // FIELD_totalCount
        "bool",    // FIELD_packetHello
        "bool",    // FIELD_packetEcho
    };
...
std::string PacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_totalCount: return long2string(pp->getTotalCount());
        case FIELD_packetHello: return bool2string(pp->getPacketHello());
        case FIELD_packetEcho: return bool2string(pp->getPacketEcho());
        default: return "";
    }
}
...
void PacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_totalCount: pp->setTotalCount(string2long(value)); break;
        case FIELD_packetHello: pp->setPacketHello(string2bool(value)); break;
        case FIELD_packetEcho: pp->setPacketEcho(string2bool(value)); break;
...
omnetpp::cValue PacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_totalCount: return pp->getTotalCount();
        case FIELD_packetHello: return pp->getPacketHello();
        case FIELD_packetEcho: return pp->getPacketEcho();
...
void PacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_totalCount: pp->setTotalCount(omnetpp::checked_int_cast<int>(value.intValue())); break;
        case FIELD_packetHello: pp->setPacketHello(value.boolValue()); break;
        case FIELD_packetEcho: pp->setPacketEcho(value.boolValue()); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'Packet'", field);
    }
}
